...
public class ImageCrawler extends WebCrawler {
	...
	private static HashMap<String, String> urlname;

	public static void configure(String[] domain, String storageFolderName,HashMap<String, String> pattHashMap) {
		ImageCrawler.crawlDomains = domain;
        ImageCrawler.urlname=pattHashMap;
